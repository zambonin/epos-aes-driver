...
int tstp_work()
{
    ...
    //TODO: change the smart_data to the right water_flow_sensor
    Water_Flow_M170 flow0(0, INTEREST_EXPIRY, static_cast<Water_Flow_M170::Mode>(Water_Flow_M170::PRIVATE | Water_Flow_M170::CUMULATIVE));
    Water_Flow_WSTAR flow1(region_station1, INTEREST_EXPIRY, INTEREST_PERIOD, Water_Flow_WSTAR::CUMULATIVE);
    Water_Flow_M170 flow2(region_station2, INTEREST_EXPIRY, INTEREST_PERIOD, Water_Flow_M170::CUMULATIVE);
